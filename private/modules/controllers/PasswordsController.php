...
final class PasswordsController
{
  ...
  public function store()
  {
    ...
    if (!RateLimit::check('forgot-password', maxAttempts: 10, windowSeconds: 900)) {
      ...
      Flash::set('errors', [
        "Trop de tentatives de soumission. Réessayez dans {$minutes} minutes.",
      ]);
    ...
    $publicSuccessMsg =
      'Si un compte existe pour cette adresse, un e-mail a été envoyé avec un lien de réinitialisation.';
