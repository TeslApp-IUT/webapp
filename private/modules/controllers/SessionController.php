...
final class SessionController
{
  ...
  public function store(): void
  {
    ...
    $remember =
      isset($_POST['remember']) && ($_POST['remember'] === '1' || $_POST['remember'] === 'on');
    ...
    try {
      ...
      if ($specId > 0) {
        try {
          ...
          error_log(
            "Erreur lors de la récupération de la spécialisation (ID {$specId}): " .
              $e->getMessage(),
          );
          $specName = null;
        }
      ...
      if ($remember) {
        ...
        setcookie(self::REMEMBER_COOKIE_NAME, $cookieValue, [
