...
final class ChargingPlannerService
{
    ...
    public function createPlan(
        ...
        $planner = new ChargingPlanner(
            id: null,
            vin: $vin,
            activationHour: $activationHour,
            deactivationHour: $deactivationHour,
     ...
     */
    private function pushAndStore(string $plannerId, ChargingPlanner $planner): void
    {
