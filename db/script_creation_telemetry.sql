...
(
    ...
    CONSTRAINT pk_charge_level PRIMARY KEY (id, vin),
...
(
    ...
    CONSTRAINT pk_charge_enable PRIMARY KEY (id, vin),
...
(
    ...
    CONSTRAINT pk_charge_scheduled PRIMARY KEY (id, vin),
...
(
    ...
    CONSTRAINT pk_temp_int PRIMARY KEY (id, vin),
...
(
    ...
    CONSTRAINT pk_keeper_mode PRIMARY KEY (id, vin),
...
(
    ...
    CONSTRAINT pk_ac_enabled PRIMARY KEY (id, vin),
